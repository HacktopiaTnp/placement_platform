...
const QuestionItemCard = ({ question }) => {
  ...
  return (
    <div className="group relative border border-border/50 shadow-lg rounded-xl p-5 card-hover bg-card/50 backdrop-blur-sm overflow-hidden animate-scale-in">
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-500 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity"></div>
      
      <h2 className="font-bold text-xl text-foreground mb-2 group-hover:gradient-text transition-all">{question?.jobPosition}</h2>
